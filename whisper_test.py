...
def transcribe_audio(audio_file, model_name="medium", language="en"):
    ...
    try:
        ...
        start_time = time.time()
        result = model.transcribe(audio_file, language=language)  # Specify language
...
def main():
    ...
    model_name = "medium"  # Fallback to "base" if needed
    language = "hi"  # Kannada language code
    ...
    try:
        ...
        if result:
            ...
            # For Streamlit: st.session_state["transcribed_text"] = result["text"]
        else:
